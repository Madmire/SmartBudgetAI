      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../pages/tables.php">
            ...
            <span class="nav-link-text ms-1">Transactions table</span>
          </a>
        </li>
        <li class="nav-item">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Transactions table</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Transactions table</h6>
        </nav>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="mailto:mamadou.sanogo@uir.ac.ma" class="font-weight-bold" target="_blank">YoungAfricansDev</a>
              </div>
            </div>
